...
required=['docs/index.html','docs/styles.css','docs/core.js','docs/app.js','docs/sw.js','docs/manifest.webmanifest','docs/icon.svg','scripts/scrape.py','scripts/scrape_v066.py','scripts/compact_client_data.py','.github/workflows/pages.yml','.github/workflows/refresh.yml']
...
assert "cache.put(req,res.clone())" in sw and "cache.match(req,{ignoreSearch:true})" in sw
