...
ROOT=Path(__file__).resolve().parents[1];DATA=ROOT/'data';DIAG=ROOT/'diagnostics';STATUS=DATA/'status.json';JST=timezone(timedelta(hours=9));SCHEMA=1
